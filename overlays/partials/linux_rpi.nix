...
with final.pkgs; rec {
  ...
  rpi3Packages_4_19 = final.pkgs.linuxPackagesFor linux_rpi3_4_19;
  rpi3Packages_4_19_hardened = final.pkgs.hardenedLinuxPackagesFor linux_rpi3_4_19_hardened;
