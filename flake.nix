{
  ...
  inputs.nixos-21_11 = { type = "github"; owner = "NixOS"; repo = "nixpkgs"; ref = "nixos-21.11"; };
  inputs.nixos-21_11-small = { type = "github"; owner = "NixOS"; repo = "nixpkgs"; ref = "nixos-21.11-small"; };
        ...
        [
...

          {
            nixpkgs.overlays = mkBefore [
              (final: prev: {
                inherit (final._channels.nixos-21_11)
                  # Broken builds on `nixpkgs`
                  ark buku krita
                  ;

                inherit (final._channels.nixos-21_11-small)
                  # "Expensive" builds
                ...
                _channels = genAttrs
                  [ "nixos-21_11" "nixos-21_11-small" "nixos-unstable" "nixos-unstable-small" "nixpkgs-unstable" "nixpkgs" ]
